...
class AlexNet(nn.Module):
    def __init__(self):
        ...
        self.classifier = [model.classifier[i] for i in range(6)]
        #self.classifier.append(nn.Dropout())
        self.classifier.append(torch.nn.Linear(4096, 3))
...
def train():
    ...
    read_dir_augment = r'/media/Harshit/augmented_data_2'
    
    #answer_train = r'/media/Harshit/train.csv'
    answer_augment = r'/media/Harshit/augmented_2.csv'
    ...
    for epoch in range(total_epochs):
        ...
        torch.save(model.state_dict(),os.path.join('./saved_weights_9','model_{}.ckpt'.format(epoch)))
        if epoch%2 !=0:
